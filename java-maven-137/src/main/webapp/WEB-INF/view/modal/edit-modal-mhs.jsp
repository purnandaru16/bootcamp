...
<div class="modal fade" id="edit-mhs" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
		  	<input type="hidden" class="form-control" id="input-id" placeholder="Enter ID">
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    <label for="input-name">Jurusan</label>
